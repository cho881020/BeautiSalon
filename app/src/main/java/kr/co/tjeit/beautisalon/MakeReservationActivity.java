...
//                Toast.makeText(mContext, position + "번 줄 선택", Toast.LENGTH_SHORT).show();
    ...
    public void setValues() {
        ...
        hairAdapter = new ArrayAdapter<String>(mContext,
    ...
    public void bindViews() {
        ...
        this.hairStyleSpinner = (Spinner) findViewById(R.id.hairStyleSpinner);this.categorySpinner = (Spinner) findViewById(R.id.categorySpinner);
